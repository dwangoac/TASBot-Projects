...
scrolldata:
    .db $b7,$d4,$db,$db,$de,$fe,$b6,$d4,$d4,$da,$bf,$81,$dd,$ea,$fe,$c3,$d7,$d8,$cc,$fe,$ca,$ce,$d8,$d2,$da,$fe,$d3,$d4,$dc,$de,$fe,$81,$d0,$cc,$fe,$df,$cb,$de,$d6,$cb,$d0,$dc,$dc,$d4,$d3,$fe,$d1,$8c,$fe,$cd,$de,$cd,$d0,$db,$9a,$fe,$d7,$d0,$cc,$fe,$dc,$ce,$cc,$d8,$d2,$fe,$d1,$8c,$fe,$d5,$ce,$8f,$8c,$db,$db,$9a,$d0,$dd,$d3,$fe,$81,$d0,$cc,$fe,$dc,$d0,$d3,$d4,$fe,$df,$de,$cc,$cc,$d8,$d1,$db,$d4,$fe,$81,$d8,$cd,$d7,$fe,$d7,$d4,$db,$df,$fe,$d5,$cb,$de,$dc,$fe,$cd,$d7,$d4,$cc,$d4,$fe,$df,$d4,$de,$df,$db,$d4,$e9,$fe,$d3,$81,$d0,$dd,$d6,$de,$b0,$b2,$9a,$fe,$bc,$d0,$cc,$cd,$d4,$cb,$d9,$ce,$dd,$9a,$fe,$b8,$db,$d0,$cb,$d8,$9a,$fe,$bb,$de,$cb,$d3,$c3,$de,$dc,$9a,$fe,$dc,$d8,$d2,$cb,$de,$f5,$f0,$f0,$9a,$fe,$be,$81,$dd,$d0,$cc,$d0,$ce,$cb,$ce,$cc,$9a,$fe,$da,$de,$d3,$d4,$81,$d4,$cb,$88,$9a,$fe,$df,$f4,$df,$db,$ce,$cc,$f2,$e9,$fe,$bc,$de,$cb,$d4,$fe,$cd,$d7,$d8,$dd,$d6,$cc,$fe,$d2,$de,$dc,$d8,$dd,$d6,$fe,$ce,$df,$fe,$cc,$de,$de,$dd,$e9,$e9,$e9,$fe,$fe,$00
