...
g++ -O2 process_image_stream/process_image/transout_full.cpp process_image_stream/process_image/octree.cpp -o process_image_stream/process_image/transout_full
