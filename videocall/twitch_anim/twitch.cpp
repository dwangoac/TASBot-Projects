...
int main ()
{
    ...
    trans_vram_data(tiles_bitplaned, final_tile_size * 8 * 8, (65 * 8 * 8) / 2, 4, 4);
    
    // Convert the border to tiles
    uint8 tilemap[SSIZE_X*SSIZE_Y*2];
    tilize_image("images/twitch.rgb", tile_set, 65, tilemap);
